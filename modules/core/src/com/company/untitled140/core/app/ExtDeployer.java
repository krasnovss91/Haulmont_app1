package com.company.untitled140.core.app;
...
@Component("untitled140_ExtDeployer")
public class ExtDeployer extends AbstractDeployer implements ExtDeployerMBean {
        ...
        try {
            ...
            String initDefaultInFirstStart = em.createQuery(
                    "select c.value from sys$Config c " +
                            "where c.name='untitled140.initDefaultInFirstStart'",
                ...
                if (StringUtils.isNotBlank(edition) && Integer.parseInt(edition) > 1) {
                    ...
                    if (initDefaultInFirstStart == null) {
                        try {
                            ...
                            config.setName("untitled140.initDefaultInFirstStart");
                        ...
                        try {
                            authentication.begin();
                            em.createQuery("update sys$Config c set c.value='false' where c.name='untitled140.initDefaultInFirstStart'",
    ...
    protected void executeInitScripts() {
        ...
        File folderDB = new File(dbDirPath + "/50-untitled140/init/" + dbmsType);
