package com.company.untitled140.web.ui.request;
...
public class RequestEdit<T extends TsCard> extends AbstractCardEditor<T> {
 ...
 */
    ...
    @Override
    protected ComponentContainer getStateHolder() {
        return (ComponentContainer) getComponent("stateHolder");
    }
